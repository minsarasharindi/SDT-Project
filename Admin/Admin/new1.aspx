<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new1.aspx.cs" Inherits="Admin.new1" %>
      ...
      <div class="nav-links" id="navLinks">
         ...
         <section class="header1">
              <div class="row2">
                    ...
                    <h3>G.T.F Captan Registration</h3>
           ...
           <div class="row1">
                 <div class="row1-one" style="width:500; height:500px;">
                     ...
                     <br>
                        ...
                        <br>
                       <input type="text" name="name" placeholder="Email" style=" width:300px; height:30px; border-radius: 10px; background: white;"></h5><br>
                        <br>
                       <input type="text" name="name" placeholder="Address" style=" width:300px; height:30px; border-radius: 10px; background: white;"></h5><br>
                       <br>
                     <input type="text" name="name" placeholder="Duration" style=" width:300px; height:30px; border-radius: 10px; background: white;"></h5><br>
                       <br>
                       <asp:Button ID="Button2" runat="server" Text="Register  Captain" CssClass="button2" />
                    </div>
               </div>
       </section>
